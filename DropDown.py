...
class Suman:
    ...
    def disselect_by_text(self):         # No Need Follow Above One
        user_display = self.driver.find_element(by=By.ID, value='search-count')
        display_dropdown = Select(user_display)
        display_dropdown.select_by_index('1')
        language = self.driver.find_element(by=By.NAME, value='languages')
    ...
    def Release_Date(self):
        ...
        Date=self.driver.find_element(by=By.NAME,value="release_date-min")
        Date.send_keys("1990-01-01")
        End_Date=self.driver.find_element(by=By.NAME,value="release_date-max")
        End_Date.send_keys("1990-02-01")

        Search_Button=self.driver.find_element(by=By.XPATH,value="//button[normalize-space()='Search']")
        Search_Button.click()
